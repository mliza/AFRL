...
\begin{document}
    ...
    \section{Optical distortion caused by propagation through turbulent shear layer \cite{10.1117/12.510945}} 
        \begin{itemize} 
    ...
    \section{Modeling Radio Communication Blackout and Blackout Mitigation in Hypersonic Vehicles \cite{doi:10.2514/1.A33122}} 
        \begin{itemize} 
    ...
    \section{Optical Refractivity of High‐Temperature Gases. I. Effects Resulting from Dissociation of Diatomic Gases \cite{doi:10.1063/1.1705906}}
        \begin{itemize} 
            \item 
        \end{itemize}

        
    \section{An Experimental Determination of the Gladstone-Dale Constants for Dissociating Oxygen \cite{doi:10.1063/1.1692629}} 
        \begin{itemize} 
            \item 
        \end{itemize}


    \section{High Enthalpy Cylinder Flow in HEG: A Basis for CFD Validation \cite{doi:10.2514/6.2003-4252}}
        \begin{itemize} 
            \item 
        \end{itemize} 
